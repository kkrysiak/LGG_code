...
req <- rbind(req,c(sect, main[1], "All", 0, 100, length(unique(cases[which(cases$Results_summary == "Normal"),"CoPath.#"]))))
req <- rbind(req,c(sect, main[2], "All", 100, 0, length(unique(cases[which(cases$Results_summary == "Abnormal"),"CoPath.#"]))))

## Testing category
sect <- "Category"
main <- lists$Testing.Category[!is.na(lists$Testing.Category)]
sub <- c("NIPS","NIPS with confirmation","NIPS with patient results")
req <- rbind(req,c(sect, main[1], "All", 30, 50, length(unique(cases[which(cases$Category == main[1]),"CoPath.#"]))))
...
req <- rbind(req,c(sect, main[2], "All", 40, 50, length(unique(cases[which(cases$Category == main[2]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[3], "All", 10, 50, length(unique(cases[which(cases$Category == main[3]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[4], "All", 10, 50, length(unique(cases[which(cases$Category == main[4]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[5], "All", 0, 20, length(unique(cases[which(cases$Category == main[5]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[6], "All", 0, 10, length(unique(cases[which(cases$Category == main[6]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[7], "All", 60, 0, length(unique(cases[which(cases$Category == main[7]),"CoPath.#"]))))
...
req <- rbind(req,c(sect, main[1], "All", 50, 0, length(unique(cases[which(cases$Category == main[1]),"CoPath.#"]))))
...
req <- rbind(req,c(sect, main[2], "All", 30, 0, length(unique(cases[which(cases$Category == main[2]),"CoPath.#"]))))
...
req <- rbind(req,c(sect, main[3], "All", 30, 0, length(unique(cases[which(cases$Category == main[3]),"CoPath.#"]))))
...
req <- rbind(req,c(sect, main[4], "All", 20, 0, length(unique(cases[which(cases$Category == main[4]),"CoPath.#"]))))
mut <- sub[grepl(4, sub)]
...
req <- rbind(req,c(sect, main[5], "All", 40, 0, length(unique(cases[which(cases$Category == main[5]),"CoPath.#"]))))
...
req <- rbind(req,c(sect, main[4], "All", 0, 0, length(unique(cases[which(cases$Category == main[4]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[5], "All", 0, 0, length(unique(cases[which(cases$Category == main[5]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[6], "All", 0, 0, length(unique(cases[which(cases$Category == main[6]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[7], "All", 0, 0, length(unique(cases[which(cases$Category == main[7]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[8], "All", 100, 0, length(unique(cases[which(cases$Category == main[8]),"CoPath.#"]))))
req <- rbind(req,c(sect, main[9], "All", 10, 0, length(unique(cases[which(cases$Category == main[9]),"CoPath.#"]))))
...
req <- rbind(req,c(sect, main[10], "All", 20, 0, length(unique(cases[which(cases$Category == main[10]),"CoPath.#"]))))
...
color_palette=c("Not met"="red","Met"="green")
